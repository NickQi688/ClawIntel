---
title: "研究+笔记+PPT之神——NotebookLM 快速上手教程"
source: "https://x.com/Formulasearch/status/2033884676415496346"
author:
  - "[[@Formulasearch]]"
published: 2026-03-17
created: 2026-04-16
description: "一、 NotebookLM是什么？notebook LM的界面NotebookLM 是 Google 推出的 AI 笔记与研究工具。它和普通聊天 AI 不太一样，核心不是“直接联网胡乱发挥”，而是围绕你上传的资料来理解、总结、提问和生成内容，更适合做学习、阅读、整理和写作辅助。..."
tags:
  - "clippings"
---
![图像](assets/研究+笔记+PPT之神——NotebookLM%20快速上手教程/Image.jpg)

## 一、 NotebookLM是什么？

![图像](assets/研究+笔记+PPT之神——NotebookLM%20快速上手教程/Image%201.jpg)
...
![图像](assets/研究+笔记+PPT之神——NotebookLM%20快速上手教程/Image%202.jpg)
...
![图像](assets/研究+笔记+PPT之神——NotebookLM%20快速上手教程/Image%203.jpg)

直接对话框中输入需求，进行研究或者把现有的资料上传进去
...
![图像](assets/研究+笔记+PPT之神——NotebookLM%20快速上手教程/Image%204.jpg)
...
![图像](assets/研究+笔记+PPT之神——NotebookLM%20快速上手教程/Image%205.jpg)

就这个质量让我自己手搓我都想不到从何入手

## 3\. 音频概览：把资料直接变成“播客式讲解”

![图像](assets/研究+笔记+PPT之神——NotebookLM%20快速上手教程/Image%206.jpg)
...
[https://youtu.be/KA\_pExdDSUo?si=rdEtMMOfD7cAc1o](https://youtu.be/KA_pExdDSUo?si=rdEtMMOfD7cAc1o)\_ 最近刚刚更新不久，相对更新、更偏展示型的能力，但也是非常有潜力和强大的功能，官方说明里，它会把资料转成一个“清晰、易消化的视觉化演示视频”。生成前还可以做一定程度的定制，具体内容可以看视频，这个功能绝对利好广大视频类博主的视频产出。

**价值：** 比纯文本摘要更适合演示、汇报、课堂复习、给别人快速解释复杂材料。 如果你有一堆文档，但想更轻松地“看懂”，这个功能会比普通摘要更直观。

## 5\. 思维导图：自动把资料变成思维导图

![图像](assets/研究+笔记+PPT之神——NotebookLM%20快速上手教程/Image%207.jpg)

思维导图会把资料中的主题关系可视化成树状分支图，帮助你先看结构，再看细节。官方强调它适合快速掌握大图景、发现概念之间的联系、帮助组织思考。

**为什么重要：** 很多资料难，不是难在字多，而是关系复杂。思维导图正好解决“结构看不清”的问题。 对课程学习、论文阅读、知识梳理、搭建写作框架都很实用。

## 6\. 闪卡/测验：直接生成学习工具

![图像](assets/研究+笔记+PPT之神——NotebookLM%20快速上手教程/Image%208.jpg)

NotebookLM 可以把资料转成抽认卡和测验题，而且不只是静态输出。官方支持：
...
![图像](assets/研究+笔记+PPT之神——NotebookLM%20快速上手教程/Image%209.jpg)

直接把ai的输出内容保存为笔记，下次的回答会直接基于此来进行回答

![图像](assets/研究+笔记+PPT之神——NotebookLM%20快速上手教程/Image%2010.jpg)

也可以新建笔记，直接记录自己的想法，同样也会纳入ai的知识库中
...
![图像](assets/研究+笔记+PPT之神——NotebookLM%20快速上手教程/Image.png)

可以任选文档，ai会根据你选中的内容进行思考回答

导入来源后，NotebookLM 会给整份来源生成自动摘要；聊天时还能选择全部来源或只选部分来源来回答问题。官方也明确说明：来源始终会被用于回答，而 notes 只有在你明确选择时才会加入提示。

![图像](assets/研究+笔记+PPT之神——NotebookLM%20快速上手教程/Image%2011.jpg)

AI的回复会直接引用上传的资料内容，“拒绝幻觉”
...
![图像](assets/研究+笔记+PPT之神——NotebookLM%20快速上手教程/Image%2012.jpg)

可以直接在用Gemini的时候，直接引用nlm当中的知识库
...
🥳**感谢您看到这里，我是Phil，前建筑师 → AI产品**

如果这篇文章对你有帮助，欢迎关注我[@Formulasearch](https://x.com/Formulasearch)，我会持续输出自己的转型历程、跨界思维和可实操的AI工具分享及教程，希望我们能够在AI时代共同进步。