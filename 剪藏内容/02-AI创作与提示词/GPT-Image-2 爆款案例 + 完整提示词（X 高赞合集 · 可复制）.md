---
title: "GPT-Image-2 爆款案例 + 完整提示词（X 高赞合集 · 可复制）"
source: "https://x.com/Formulasearch/status/2046790896482455890"
author:
  - "[[@Formulasearch]]"
published: 2026-04-22
created: 2026-04-24
description: "生成一张Grok的小红书界面个人主页截图GPT-Image-2 上线几天，X 时间线已经被刷屏了，恰好image2开始全量上线，我根据这几天的时间线以及个人的尝试，收集整理了一些提示词和案例。图像生成的边界，如今又被 GPT-Image-2 推了一大步，banana已经可以退下王..."
tags:
  - "clippings"
---
![图像](https://pbs.twimg.com/media/HGc7Jt3WEAALfll?format=jpg&name=large)

![图像](https://pbs.twimg.com/media/HGc7QSGXwAAAf5L?format=jpg&name=large)

```text
生成一张Grok的小红书界面个人主页截图
```

**GPT-Image-2 上线几天，X 时间线已经被刷屏了，恰好image2开始全量上线，我根据这几天的时间线以及个人的尝试，收集整理了一些提示词和案例。**

图像生成的边界，如今又被 GPT-Image-2 推了一大步，banana已经可以退下王座了。

下面是我从 X 高赞帖里筛出来的 8 类案例，全部配完整 prompt。**都可以直接复制到 ChatGPT 用 GPT-Image-2 生成**。
...
![图像](https://pbs.twimg.com/media/HGeugSQWAAAgrn1?format=jpg&name=large)

图来源于[@Khazix0918](https://x.com/@Khazix0918)

```text
生成一张中文，初三年级的数学学科期中考试试卷
```

![图像](https://pbs.twimg.com/media/HGeu6dcXYAAh5Tb?format=jpg&name=large)

图来源于[@Khazix0918](https://x.com/@Khazix0918)

![图像](https://pbs.twimg.com/media/HGewBVoXEAAR8zk?format=jpg&name=large)

图来源于[@akokoi1](https://x.com/@akokoi1)

生成品牌视觉设计全案

![图像](https://pbs.twimg.com/media/HGevluEWAAA7CiM?format=jpg&name=large)

图来源于[@Jackywine](https://x.com/@Jackywine)

## 一、资源整理：一个 GitHub 仓库省你一个月 prompt 试错

这周 X 上被反复转发最多的，是这个仓库：

🔗 **awesome-gpt-image-2-prompts** [github.com/EvoLinkAI/awesome-gpt-image-2-prompts](https://github.com/EvoLinkAI/awesome-gpt-image-2-prompts)

500+ Star 的量级，覆盖人像摄影、海报、角色设计、UI mockup 四个大类，每类都带图和完整 prompt。X 上绝大多数刷屏帖的 prompt，都能在里面找到原始出处或同款。

另外有两个中文友好库也可以收藏：

- [github.com/YouMind-OpenLab/awesome-gpt-image-2](https://github.com/YouMind-OpenLab/awesome-gpt-image-2)
- [opennana.com/awesome-prompt-gallery?model=ChatGPT](https://opennana.com/awesome-prompt-gallery?model=ChatGPT)
...
Pasted image 20260422013348.png粘贴的图片 20260422013348.png

![图像](https://pbs.twimg.com/media/HGc4_dhW8AA9pf8?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HGc5Fv6WEAAUtqQ?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HGc5Ya9WMAApGuC?format=jpg&name=large)

随手发一张车的图，让GPT-image-2去生成的官网。

![图像](https://pbs.twimg.com/media/HGewv6hWoAETfok?format=jpg&name=large)

图片来源于 [@op7418](https://x.com/@op7418)
...
![图像](https://pbs.twimg.com/media/HGc5i7VWoAA7FFp?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HGc5vJJWkAAbd8q?format=jpg&name=large)
...
这一类在 X 上短剧/AI 影视/小说图文化圈已经转得很凶。下面这一版是一个末日生存题材女主的 12 分镜样例（分 4 组，每组 3 格），你可以**把主角设定、故事线整段换掉**，结构复用。
...
![图像](https://pbs.twimg.com/media/HGc5_oeXMAE32Y0?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HGc6MrAWgAEvHvg?format=jpg&name=large)

**或者换成《流浪地球3》的电影剧照：**

![图像](https://pbs.twimg.com/media/HGc6PfFX0AAKLM8?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HGc6T9HXoAAgZoo?format=jpg&name=large)

**8.2 大师海报：柯布西耶与现代建筑**

另一种是"建筑大师研究海报"——大师侧脸剪影作画布，他一生的作品沿着时间轴在脸内从下往上堆叠。

完整 prompt（JSON 格式，直接复制；只用 prompt 字段也能跑，negative\_prompt 和 parameters 是给支持的接口用的）：
...
**怎么改**：把 LE CORBUSIER 换成你要研究的那位——FRANK LLOYD WRIGHT（配流水别墅 / 古根海姆）/ ZAHA HADID（配 MAXXI / 广州大剧院）/ KENGO KUMA（配竹屋 / 长城脚下的公社）/ WANG SHU（配宁波美术馆 / 中国美院象山）——然后把 key\_elements 里的代表作清单和年份也一起换。一晚上能给整个流派做一套海报集。

![图像](https://pbs.twimg.com/media/HGc6haTW4AEryO7?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HGc6pZQX0AAtWn2?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HGc6xnRW4AADX-Y?format=jpg&name=large)

```text
生成一张抖音直播间，内容是马斯克和库克连麦打pk
```

![图像](https://pbs.twimg.com/media/HGeyFU-XwAAomQG?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HGc65HJWcAAAa9n?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HGexUccW0AACYx2?format=jpg&name=large)

图片来源于[@Khazix0918](https://x.com/@Khazix0918)
...
![图像](https://pbs.twimg.com/media/HGc8OE6XUAA2p4O?format=jpg&name=large)

![图像](https://pbs.twimg.com/media/HGc8jvSX0AAJ--I?format=jpg&name=large)
...
这波 GPT-Image-2 的众多 prompt，如果你试出来有意思的图，欢迎与大家分享~！如果有合作意向，也欢迎随时私信联系我~
