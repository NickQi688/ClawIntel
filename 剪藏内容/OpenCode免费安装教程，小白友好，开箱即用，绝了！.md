...
source: "https://x.com/vista8/status/2010540934359097689"
author:
  - "[[Unknown]]"
...
![图像](https://pbs.twimg.com/media/G-beyE9a8AApQ99?format=jpg&name=large)如果你用过Claude Code可能会比较熟悉。

如果没用过也不要慌，你可以输入/model

你就能看到大量免费模型（后面带free的就可以用），，比如GLM-4.7等。

你如果订阅了GPT、Gemini可以输入/connect

![](assets/OpenCode免费安装教程，小白友好，开箱即用，绝了！/bf438a6efd375ffcab3ca29e90a160be.png)
...
- Exa（联网搜索）
- Context7（官方文档查询）
- [Grep.app](https://grep.app/)（GitHub 代码海搜）
